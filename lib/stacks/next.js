...
async function next(projectName, projectPath) {
  output.info(`🚀 Creating ${chalk.bold(chalk.green(projectName))} using ${chalk.bold('@invoker/next')}...`);

  const hostedInfo = hostedGitInfo.fromUrl('https://github.com/meridianid/invoker-next#master');
