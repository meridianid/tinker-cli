...
exports.outOfDate = function(current, latest) {
  ...
  There is a new version for ${chalk.bold(chalk.green('mid-tinker-cli'))} available ${chalk.bold(chalk.green(latest))}.
...
exports.aheadOfPublished = function() {
  ...
  The version of ${chalk.green('mid-tinker-cli')} you are
  using is ahead on the npm one.
...
exports.help = function() {
  ...
  If you have any problems, do not hesitate to file an issue:
    ${chalk.cyan('https://github.com/meridianid/tinker-cli/issues/new')}
  `);
};
...
exports.start = function(projectName, type) {
  ...
  ${chalk.green('https://github.com/meridianid/tinker-cli/issues')}`);
};
